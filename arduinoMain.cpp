...
/* Command i am using to flash this guy
avrdude -c avrispmkII -P usb -p atmega328p -U flash:w:main.hex:i
*/
...
void wifiCb(void* response)
{
    ...
    if(res.getArgc() == 1) {
        ...
        if(status == STATION_GOT_IP) {
            ...
            mqtt.connect("192.168.1.101", 1883, false);
            wifiConnected = true;
...
void setup(void)
{
    ...
    esp.wifiConnect("bittner","somePassword");
